    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="w-full bg-white/10 rounded-full h-2">
          <div
            className="bg-gradient-to-r from-brand-cyan to-brand-purple h-2 rounded-full transition-all duration-300"
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={handleNext}
          className="px-6 py-3 rounded-lg font-medium bg-gradient-to-r from-brand-cyan to-brand-purple text-white hover:opacity-90 transition"
        >
